...
<div class="content">
    <div class="container">
        ...
        <div class="checkout checkout-input">
            <div class="title-group">
                <h3 class="title secondary-title"><span class="step">STEP 2.</span>비회원 주문 시 정보 수집 동의</h3>
                <a href="#none" class="button-circle"><i class="icon-plus"></i></a>
            </div>
            <div class="box guest-checkbox-agree">
                ...
                <div class="checkbox">
                    ...
                    <label for="agree_terms" class="checkbox-label primary">이용약관 및 개인 정보 수집 및 이용에 동의합니다.</label>
                </div>
            </div>
        </div>
        <!-- 약관동의 //end -->
        ...
        <div class="checkout checkout-input">
            <div class="title-group">
                <h3 class="title secondary-title"><span class="step">STEP 3.</span>주문자 정보</h3>
                <a href="#none" class="button-circle"><i class="icon-plus"></i></a>
            </div>
            <div class="box">
                <ul class="input-list">
        ...
        <div class="checkout checkout-input">
            <div class="title-group">
                <h3 class="title secondary-title"><span class="step">STEP 4.</span>배송지 정보</h3>
                <a href="#none" class="button-circle"><i class="icon-plus"></i></a>
            </div>
            <div class="box">
                <ul class="input-list">
