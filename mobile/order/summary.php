    ...
    <div class="container">
        ...
        <div class="ordered-check">
            <div class="confirm-message">
                ...
                주문 현황은 <a href="#" class="link-line">마이페이지&gt;주문/배송 조회</a>에서<br>확인하실 수 있습니다.
            </div>
        ...
        <div class="summary">
            ...
            <ul class="ordered-payment-info">
                ...
                <li>
                    <span class="ordered-payment-title">할인 금액</span>
                    <strong class="ordered-payment-price"><em class="benton">-5,000</em>원</strong>
                </li>
                <li class="ordered-coupon">
                    <span class="ordered-payment-title payment-coupon">할인쿠폰</span>
                    <strong class="ordered-payment-price payment-coupon"><em class="benton">5,000</em>원</strong>
                </li>
