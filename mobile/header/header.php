        ...
        <ul class="sidebar-menu level-1">
            ...
            <li class="menu-item child-item">
                ...
                <ul class="level-2 child-item">
                    ...
                    <li class="child-item"><a href="#">bags</a></li>
                    <li class="child-item"><a href="#">accessories</a></li>
                </ul>
            </li>
            <li class="menu-item child-item">
                <a href="#">sunglasses</a>
            ...
            <li class="menu-item"><a href="#">jewelry</a></li>
            <li class="menu-item"><a href="#">home</a></li>
            <li class="menu-item"><a href="#">kids</a></li>
            <li class="menu-item"><a href="#">journal</a></li>
            <li>
                <ul class="sidebar-quick">
                    <li><a href="#"><i class="icon-heart-empty"></i>wish list</a></li>
                    <li><a href="#"><i class="icon-shoppingbag-trapezoid"></i>shopping bag</a></li>
                    <li><a href="#"><i class="icon-bullseye"></i>my page</a></li>
                    <li class="login logout"><a href="#">logout</a></li><!-- [D] 로그아웃 시 logout 클래스 삭제 -->
                </ul>
            </li>
        </ul>
