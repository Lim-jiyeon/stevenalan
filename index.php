...
<head>
    ...
    <style type="text/css">
        ...
        .markup-list #pc {margin-top:40px;padding-top:40px;background: url('./pc/images/common/washed-line.png') repeat-x 0 0;}
        .markup-list .top {position:fixed;right:20px;bottom:15px;}
    </style>
</head>
<body>
<div id="wrap" class="markup-list">
    <div class="header">
        <h1 class="site-brand col-sx-12">Steven Alan <span><a href="#mobile">(MOBILE</a>, <a href="#pc">PC)</a></span><br>퍼블리싱 작업 현황</h1>
    </div>
    <div class="content">
        <div class="container">
            <div class="row">
...
<!--                        <li>5.2 <a href="./mobile/join/guest-login.php">비회원 주문 로그인</a></li>-->
                ...
                <div id="pc" class="col-xs-12">
                    ...
                    <ul>
                        ...
                        <li>6.10 <a href="./pc/email/personal-support.html">1:1 문의 답변</a></li>
                        <li>6.11 <a href="./pc/email/reject-email.html">이메일 수신거부</a></li>
                    </ul>
                </div>
            </div>
