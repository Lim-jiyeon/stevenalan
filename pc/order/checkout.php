                                ...
                                <tr class="shipping-memo">
                                    ...
                                    <td>
                                        ...
                                        <div class="checkbox checkbox-block">
                                            <input type="checkbox" id="update_address" checked="checked">
                                            <label for="update_address" class="checkbox-display"></label>
                                            <label for="update_address" class="checkbox-label">주문자 주소 업데이트</label>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
                        ...
                        <div class="checkout coupon-info">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="coupon-list">
                                    <table class="table table-list">
                                        <caption class="sr-only">할인 정보 목록</caption>
                                        <colgroup>
                                            <col class="col-xs-4">
                                            <col class="col-xs-1">
                                            <col class="col-xs-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="selectbox">
                                                    ...
                                                    <select onchange="selectboxEvent(this);">
                                                        <option value="[C376888392813] 5% 추가할인 쿠폰">[C376888392813] 5% 추가할인 쿠폰</option>
                                                        <option value="선택1">선택1</option>
                                                        <option value="선택2">선택2</option>
                                                        <option value="선택3">선택3</option>
                                                        <option value="선택4">선택4</option>
