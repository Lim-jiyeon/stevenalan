    ...
    <div class="content">
        <div class="container personal-support-wrap">
            ...
            <div class="bgSection col-xs-10">
                ...
                <table width="100%" class="personal-support-table folding-table">
                    <thead>
                        <tr>
                            <th>유형</th>
                            <th>제목</th>
                    ...
                    <tbody>
                        <tr class="master">
                            <td>주문/결제 문의</td>
                            <td class="align-left">결제 내역이 이상하네요. 확인좀 부탁드려요.</td>
                            <td>2016-06-28</td>
                            <td><span class="delete"><a href="#">삭제</a></span></td>
                        </tr>
                        <tr class="slave">
                            <td colspan="4">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="in_slave">
                                                ...
                                                <p>- 주문상품 : <span>[상품]3000142207</span></p>
                                                <p>- 첨부파일 : <span>attachment.product.jpg</span></p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr class="master">
                            <td>배송 문의</td>
                            <td class="align-left">배송은 얼마나 걸리나요?</td>
                            <td>2016-06-28</td>
                            <td><span class="reply-complete">답변완료</span></td>
                        </tr>
                        <tr class="slave">
                            <td colspan="4">
                                <table width="100%">
