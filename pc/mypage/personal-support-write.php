                ...
                <div class="in_modal">
                    ...
                    <table class="table table-list">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="radio">
                                    <input type="radio" id="product-select" name="orderProductSelect" checked>
                                    <label for="product-select" class="radio-display"></label>
                                    <label for="product-select" class="radio-label sr-only">상품선택</label>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="radio">
                                    <input type="radio" id="product-select2" name="orderProductSelect">
                                    <label for="product-select2" class="radio-display"></label>
                                    <label for="product-select2" class="radio-label sr-only">상품선택</label>
                                </div>
                            </td>
                            <td class="product-info aline-left">
                                <div class="item-info">
