                ...
                <div class="col-xs-10">
                    <div class="box return-refund-exchange">
                        ...
                        <div class="complete-box">
                            <strong class="confirm-message">주문 취소가 완료되었습니다.</strong>
                        ...
                        <div class="private-info exchange-info">
                            <h3 class="table-title">주문 취소 상품</h3>
                            <table class="table table-list">
                                <caption class="sr-only">주문 취소 상품 목록</caption>
                                <colgroup>
                                    <col class="col-xs-6">
                                    <col class="col-xs-6">
                                </colgroup>
                        ...
                        <div class="button-align-center">
                            <a href="#" class="button button-large button-primary"><span>취소처리현황 보기</span></a>
                        </div>
